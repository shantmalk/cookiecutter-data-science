...
# Add git submodules
print(json.loads(json.dumps("{{ cookiecutter.include_shared_library_submodule }}"))["Yes"])
print("{{ cookiecutter.include_shared_library_submodule.env_git_url_shared_library_submodule }}")
